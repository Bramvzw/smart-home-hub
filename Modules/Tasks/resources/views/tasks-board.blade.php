...
@section('content')
    <div class="flex flex-col h-screen overflow-hidden bg-gradient-to-br from-gray-900 to-gray-800 text-white">
                    ...
                    <div class="flex flex-col space-y-4 mb-6">
                        ...
                        <div class="bg-gray-800 rounded-lg p-4 shadow-md border border-gray-700">
                            <div class="flex flex-col md:flex-row md:items-center space-y-3 md:space-y-0 md:space-x-4">
                                <div class="flex-grow">
                                    <div class="relative">
                                        <input type="text" id="task-search" placeholder="Search tasks..." class="w-full pl-10 pr-4 py-2 bg-gray-700 border border-gray-600 text-white rounded-lg focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition-colors">
                                ...
                                <div class="flex space-x-2">
                                    <button id="filter-button" class="bg-gray-700 hover:bg-gray-600 text-white font-medium py-2 px-4 rounded-md transition-colors flex items-center">
                                    ...
                                    <button id="clear-filters-button" class="bg-gray-700 hover:bg-gray-600 text-white font-medium py-2 px-4 rounded-md transition-colors flex items-center">
                                        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            ...
                            <div id="filter-options" class="hidden mt-4 pt-4 border-t border-gray-700 grid grid-cols-1 md:grid-cols-3 gap-4">
                                <div>
                                    <label for="filter-priority" class="block text-gray-300 font-medium mb-2">Priority</label>
                                    <select id="filter-priority" class="w-full px-4 py-2 bg-gray-700 border border-gray-600 text-white rounded-lg focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition-colors">
                                ...
                                <div>
                                    <label for="filter-due-date" class="block text-gray-300 font-medium mb-2">Due Date</label>
                                    <select id="filter-due-date" class="w-full px-4 py-2 bg-gray-700 border border-gray-600 text-white rounded-lg focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition-colors">
    ...
    <div id="add-lane-modal" class="fixed inset-0 bg-black bg-opacity-70 flex items-center justify-center hidden backdrop-blur-sm z-50 transition-opacity duration-300">
        <div class="bg-gray-800 p-6 rounded-xl shadow-2xl w-96 border border-gray-700 transform transition-all duration-300">
            <div class="flex justify-between items-center mb-6">
                ...
                <button type="button" id="cancel-add-lane" class="text-gray-400 hover:text-white transition-colors">
            ...
            <form id="add-lane-form">
                ...
                <div class="flex justify-end space-x-3">
                    <button type="button" id="cancel-add-lane" class="bg-gray-700 hover:bg-gray-600 text-gray-300 font-medium py-2 px-5 rounded-lg transition-colors">
                        Cancel
                    </button>
    ...
    <div id="add-task-modal" class="fixed inset-0 bg-black bg-opacity-70 flex items-center justify-center hidden backdrop-blur-sm z-50 transition-opacity duration-300">
        <div class="bg-gray-800 p-6 rounded-xl shadow-2xl w-[500px] max-h-[90vh] overflow-y-auto border border-gray-700 transform transition-all duration-300">
            ...
            <form id="add-task-form">
                ...
                <div class="mb-5">
                    <label for="task-description" class="block text-gray-300 font-medium mb-2">Description (supports formatting)</label>
                    <textarea id="task-description" name="description" class="w-full px-4 py-3 bg-gray-700 border border-gray-600 text-white rounded-lg focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition-colors" rows="5" placeholder="Enter task description..."></textarea>
                ...
                <div class="mb-5">
                    <label class="block text-gray-300 font-medium mb-2">URLs</label>
                    <div id="task-urls-container" class="space-y-2">
                        <!-- URL inputs will be added here dynamically -->
                        <div class="flex space-x-2">
                            <input type="url" name="urls[]" class="flex-grow px-4 py-2 bg-gray-700 border border-gray-600 text-white rounded-lg focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition-colors" placeholder="https://example.com">
                            <button type="button" class="remove-url-button bg-gray-700 hover:bg-gray-600 text-gray-300 hover:text-red-400 font-medium py-2 px-3 rounded-lg transition-colors text-sm">
                    ...
                    <button type="button" id="add-url-button-new" class="mt-2 bg-gray-700 hover:bg-gray-600 text-gray-300 font-medium py-1 px-3 rounded-lg transition-colors text-sm flex items-center">
    ...
    <div id="edit-task-modal" class="fixed inset-0 bg-black bg-opacity-70 flex items-center justify-center hidden backdrop-blur-sm z-50 transition-opacity duration-300">
        <div class="bg-gray-800 p-6 rounded-xl shadow-2xl w-[500px] max-h-[90vh] overflow-y-auto border border-gray-700 transform transition-all duration-300">
            ...
            <form id="edit-task-form">
                ...
                <div class="mb-5">
                    <label for="edit-task-description" class="block text-gray-300 font-medium mb-2">Description (supports formatting)</label>
                    <textarea id="edit-task-description" name="description" class="w-full px-4 py-3 bg-gray-700 border border-gray-600 text-white rounded-lg focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition-colors" rows="5"></textarea>
                    <div class="mt-1 text-xs text-gray-400">
                        <p>Keyboard shortcuts: <span class="bg-gray-700 px-1 rounded">⌘B</span> Bold, <span class="bg-gray-700 px-1 rounded">⌘I</span> Italic, <span class="bg-gray-700 px-1 rounded">⌘K</span> Link, <span class="bg-gray-700 px-1 rounded">⌘⇧7</span> Numbered list, <span class="bg-gray-700 px-1 rounded">⌘⇧8</span> Bullet list, <span class="bg-gray-700 px-1 rounded">⌘⇧9</span> Checklist</p>
                    </div>
                </div>
                ...
                <div class="mb-5">
                    <label class="block text-gray-300 font-medium mb-2">URLs</label>
                    <div id="edit-task-urls-container" class="space-y-2">
                        <!-- URL inputs will be added here dynamically -->
                    </div>
                    <button type="button" id="add-url-button" class="mt-2 bg-gray-700 hover:bg-gray-600 text-gray-300 font-medium py-1 px-3 rounded-lg transition-colors text-sm flex items-center">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 mr-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6v6m0 0v6m0-6h6m-6 0H6" />
                        </svg>
                        Add URL
                ...
                <div class="mb-5">
                    <label class="block text-gray-300 font-medium mb-2">Dependencies</label>
                    <div id="task-dependencies-container" class="space-y-2 mb-2">
                        <!-- Dependencies will be added here dynamically -->
                    </div>
                    <div class="flex space-x-2">
                        <select id="dependency-select" class="flex-grow px-4 py-2 bg-gray-700 border border-gray-600 text-white rounded-lg focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition-colors">
                            <option value="">Select a task</option>
                            <!-- Task options will be added here dynamically -->
                        </select>
                        <button type="button" id="add-dependency-button" class="bg-gray-700 hover:bg-gray-600 text-gray-300 font-medium py-2 px-3 rounded-lg transition-colors text-sm">
                            Add
                        </button>
                    </div>
                </div>
                ...
                <div class="mb-5">
                    <label class="block text-gray-300 font-medium mb-2">Checklists</label>
                    <div id="task-checklists-container" class="space-y-4 mb-2">
                        <!-- Checklists will be added here dynamically -->
                    </div>
                    <div class="flex space-x-2">
                        <input type="text" id="checklist-title-input" placeholder="Checklist title" class="flex-grow px-4 py-2 bg-gray-700 border border-gray-600 text-white rounded-lg focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition-colors">
                        <button type="button" id="add-checklist-button" class="bg-gray-700 hover:bg-gray-600 text-gray-300 font-medium py-2 px-3 rounded-lg transition-colors text-sm">
                            Add
                        </button>
                    </div>
                </div>

<div class="spotify-controls">
    ...
    <button type="button" id="previous-btn" class="spotify-icon-btn" aria-label="Vorige">
        <svg class="w-6 h-6" fill="currentColor" viewBox="0 0 24 24"><path d="M6 6h2v12H6zm3.5 6 8.5 6V6z"/></svg>
    </button>
    <button type="button"
            id="play-pause-btn"
            class="spotify-play-btn"
            aria-label="{{ ($playbackState['is_playing'] ?? false) ? 'Pauze' : 'Afspelen' }}">
    ...
    <button type="button" id="next-btn" class="spotify-icon-btn" aria-label="Volgende">
        <svg class="w-6 h-6" fill="currentColor" viewBox="0 0 24 24"><path d="m6 18 8.5-6L6 6v12ZM16 6v12h2V6h-2Z"/></svg>
    </button>
    <button type="button" id="repeat-btn" class="spotify-icon-btn" data-repeat-state="{{ $playbackState['repeat_state'] ?? 'off' }}" aria-label="Herhalen">
    ...
    <button type="button" id="like-btn" class="spotify-icon-btn" aria-label="Bewaren">

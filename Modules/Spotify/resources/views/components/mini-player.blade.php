...
<footer class="spotify-mini" aria-label="Mini afspeelbalk">
    ...
    <div class="spotify-mini-row">
        <button type="button" class="spotify-mini-now" data-tab-jump="panel-playing">
            ...
            <span class="spotify-mini-meta">
                <span data-track-name class="spotify-mini-title">{{ $playbackState['item']['name'] ?? 'Onbekend nummer' }}</span>
        ...
        <div class="spotify-mini-transport">
            ...
            <button type="button" class="spotify-mini-btn" data-spotify-control="previous" aria-label="Vorige">
                <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24"><path d="M6 6h2v12H6zm3.5 6 8.5 6V6z"/></svg>
            </button>
            <button type="button" class="spotify-mini-play" data-spotify-control="toggle-play" aria-label="{{ $isPlaying ? 'Pauze' : 'Afspelen' }}">
                @if($isPlaying)
            ...
            <button type="button" class="spotify-mini-btn" data-spotify-control="next" aria-label="Volgende">
                <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24"><path d="m6 18 8.5-6L6 6v12ZM16 6v12h2V6h-2Z"/></svg>
            </button>
            <button type="button" class="spotify-mini-btn" data-spotify-control="repeat" aria-label="Herhalen">
        ...
        <div class="spotify-mini-right">
            <button type="button" class="spotify-mini-btn" data-spotify-control="like" aria-label="Bewaren">

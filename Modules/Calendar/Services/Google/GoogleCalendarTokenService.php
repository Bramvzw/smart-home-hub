...
class GoogleCalendarTokenService
{
    public function authorizationUrl(): string
    {
        ...
        return 'https://accounts.google.com/o/oauth2/v2/auth?'.http_build_query([
            'client_id' => (string) config('calendar.google.client_id'),
            'redirect_uri' => (string) config('calendar.google.redirect'),
            'response_type' => 'code',
    ...
    public function exchangeCode(string $code): GoogleCalendarToken
    {
        ...
        $response = Http::asForm()
            ...
            ->post('https://oauth2.googleapis.com/token', [
                'client_id' => (string) config('calendar.google.client_id'),
                'client_secret' => (string) config('calendar.google.client_secret'),
                'redirect_uri' => (string) config('calendar.google.redirect'),
    ...
    {
        return Schema::hasTable('google_calendar_tokens') && GoogleCalendarToken::query()->exists();
    }
